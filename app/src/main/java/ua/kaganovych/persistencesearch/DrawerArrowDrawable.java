...
public abstract class DrawerArrowDrawable extends Drawable{
    ...
    DrawerArrowDrawable(Context context) {
        TypedArray typedArray = context.getTheme().obtainStyledAttributes((AttributeSet)null, android.support.v7.appcompat.R.styleable.DrawerArrowToggle, android.support.v7.appcompat.R.attr.drawerArrowStyle, android.support.v7.appcompat.R.style.Base_Widget_AppCompat_DrawerArrowToggle);
        this.mPaint.setAntiAlias(true);
        this.mPaint.setColor(typedArray.getColor(android.support.v7.appcompat.R.styleable.DrawerArrowToggle_color, 0));
        this.mSize = typedArray.getDimensionPixelSize(android.support.v7.appcompat.R.styleable.DrawerArrowToggle_drawableSize, 0);
        this.mBarSize = (float)Math.round(typedArray.getDimension(android.support.v7.appcompat.R.styleable.DrawerArrowToggle_barSize, 0.0F));
        this.mTopBottomArrowSize = (float)Math.round(typedArray.getDimension(android.support.v7.appcompat.R.styleable.DrawerArrowToggle_topBottomBarArrowSize, 0.0F));
        this.mBarThickness = typedArray.getDimension(android.support.v7.appcompat.R.styleable.DrawerArrowToggle_thickness, 0.0F);
        this.mBarGap = (float)Math.round(typedArray.getDimension(android.support.v7.appcompat.R.styleable.DrawerArrowToggle_gapBetweenBars, 0.0F));
        this.mSpin = typedArray.getBoolean(android.support.v7.appcompat.R.styleable.DrawerArrowToggle_spinBars, true);
        this.mMiddleArrowSize = typedArray.getDimension(android.support.v7.appcompat.R.styleable.DrawerArrowToggle_middleBarArrowSize, 0.0F);
